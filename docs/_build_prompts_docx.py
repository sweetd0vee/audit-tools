...
STEPS: list[dict] = [
    ...
    },
    {
        ...
        "purpose": (
            "Ответ строго по дословным фрагментам скачанных актов. Без карточек саммари "
            "в контексте. Пустая выборка — фиксированный отказ, модель не вызывается. "
            "Без префикса «вопрос» этот промпт не вызывается."
        ),
        ...
        "prompts": [
            ...
            },
            {
                ...
                "why": (
                    "Сюда кладутся тема проверки, вопрос аудитора и дословные фрагменты "
                    "индекса. Карточки саммари сюда не входят — иначе модель цитирует "
                    "номер статьи из конспекта."
                ),
                "placeholders": [
                    "inspection",
                    "keywords",
