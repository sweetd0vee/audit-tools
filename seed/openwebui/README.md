...
| `functions/audit_agent.py` | **главный агент.** Admin → Functions. Как ставить: [AGENT.md](AGENT.md). Как пользоваться: [AUDITOR.md](../../docs/AUDITOR.md) |
...
5. Агент: Admin → Functions, вставить `functions/audit_agent.py` — см. [AGENT.md](AGENT.md). Сценарий аудитора: [`docs/AUDITOR.md`](../../docs/AUDITOR.md).
